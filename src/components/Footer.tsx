        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 items-start">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            <a href="/" className="flex items-center">
              <img src="https://yrgtjzgwuzyupvrtefwo.supabase.co/storage/v1/object/public/storageImagens/logo_karcash-removebg_1.webp" alt="KarCash Logo" className="h-10 w-auto opacity-80 hover:opacity-100 transition-opacity" />
            </a>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex flex-col items-center gap-2 text-sm text-muted-foreground font-medium">
          ...
          <div className="flex flex-col items-center md:items-end gap-4">
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-10 h-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground hover:bg-primary hover:text-primary-foreground transition-all shadow-sm"
