...
export const ScarcitySection = () => {
    return (
        <section className="py-[120px] bg-background relative overflow-hidden flex flex-col items-center">
            ...
            {/* Glowing Accents */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-primary/10 cursor-default blur-[120px] rounded-full pointer-events-none" />
            
            <div className="container mx-auto px-4 relative z-10 font-display">
                <ScrollReveal>
                    <div className="max-w-6xl mx-auto">
                        <div className="flex flex-col lg:flex-row items-center gap-12 p-8 md:p-16 rounded-[40px] bg-card border border-white/5 relative overflow-hidden group shadow-2xl">
                            ...
                            <div className="lg:w-1/2 relative space-y-8">
                                ...
                                <div className="space-y-4">
                                    <h2 className="text-4xl md:text-5xl text-white uppercase leading-[1.1] font-black tracking-tighter">
                                        Não é <span className="text-primary italic">para todos.</span><br />
                                        E esse é o segredo.
                                    </h2>
                                    <p className="text-white/60 text-base md:text-lg normal-case font-medium tracking-tight leading-relaxed max-w-sm">
                                ...
                                <div className="p-6 rounded-2xl bg-black/40 border border-white/5 space-y-4 shadow-inner">
                                    <div className="flex justify-between items-center pb-4 border-b border-white/5">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-[10px] font-bold text-white/20 uppercase tracking-widest">Status do Portal</span>
                                        </div>
                                        <div className="flex items-center gap-2">
                                            <div className="h-2 w-2 rounded-full bg-primary animate-pulse" />
                                            <span className="text-[10px] font-black text-primary uppercase drop-shadow-[0_0_8px_rgba(0,255,0,0.5)]">Membros VIP Online</span>
                                        </div>
                                    </div>
                                    <div className="space-y-3">
                                        <div className="space-y-3 pb-2">
                                            <p className="text-[10px] text-white/20 font-bold leading-relaxed uppercase tracking-widest">Oportunidades Hoje</p>
                                            <span className="text-xl font-bold text-primary tracking-tighter uppercase">10 VEÍCULOS RAROS</span>
                                        </div>
                                        <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden">
                                            <motion.div 
                                                className="h-full bg-primary shadow-[0_0_15px_rgba(0,255,0,0.6)]"
                                                initial={{ width: "0%" }}
                                    ...
                                    <div className="flex items-center gap-4 pt-2">
                                        <div className="flex items-center gap-1.5 text-[9px] font-bold text-white/10 uppercase">
                            ...
                            <div className="lg:w-1/2 flex flex-col space-y-6 text-left border-l border-white/5 pl-0 lg:pl-12">
                                ...
                                <div className="opacity-40">
                                    <h4 className="text-white/30 font-bold text-[10px] tracking-widest uppercase mb-4">NÃO É PARA QUEM:</h4>
                                    <ul className="space-y-2 text-xs text-white/40 line-through decoration-white/10 italic">
                            ...
                            <div className="absolute bottom-0 left-0 p-8 opacity-20 group-hover:opacity-60 transition-opacity">
